...
export default function RegisterPage() {
  ...
  return (
    <main className="min-h-screen bg-zinc-950 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 left-1/4 w-60 h-60 bg-blue-600/10 rounded-full blur-[80px] pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-zinc-900/60 border border-zinc-800 rounded-[2rem] p-8 sm:p-10 backdrop-blur-xl shadow-2xl">
          <div className="space-y-2 text-center mb-8">
            <p className="text-xs uppercase tracking-[0.3em] text-purple-400 font-bold">Join B.Art</p>
            <h1 className="text-2xl font-bold text-white">Create Your Account</h1>
            <p className="text-sm text-zinc-500">Use Gmail or iCloud to get started</p>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-white font-bold rounded-xl transition text-sm disabled:opacity-60 flex items-center justify-center gap-2"
            >
              <Sparkles size={16} />
